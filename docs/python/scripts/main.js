const store = new Vuex.Store({
    state: {
        ...
        sectionList: [
            ...
            {id: 2, title: 'What is Python?', content: [
            ...
            {id: 5, title: 'Conditionals', content: [
                {title: "Introduction", columns: false, content: [{
                    id: 0,
            ...
            {id: 6, title: 'Function Basics', content: [
            ...
            {id: 9, title: 'Objects & Methods', content: [
            ...
            {id: 10, title: 'Tuples, Sets & Lists', content: [
                {title: "Coming soon :]", columns: false, content: []}
            ]},
            {id: 11, title: 'Dictionaries', content: [
                {title: "Coming soon :]", columns: false, content: []}
            ]},
            {id: 12, title: 'Loops', content: [
                {title: "Coming soon :]", columns: false, content: []}
            ]},
            {id: 13, title: 'Terraria Server Project', content: [
                {title: "Coming soon :]", columns: false, content: []}
            ]}
            // {id: 0, title: '', content: [
        ...
        navList: [
            { id: 0, title: "The Basics", content: [
                ...
                { id: 1, text: '1.1 - Getting Started'},
                { id: 2, text: '1.2 - What is Python?'},
                { id: 3, text: '1.3 - Expressions'},
                { id: 4, text: '1.4 - Variables'},
                { id: 5, text: '1.5 - Conditionals'},
                { id: 6, text: '1.6 - Function Basics'},
                { id: 7, text: '1.7 - Formatting & Docstrings'},
                { id: 8, text: '1.8 - Types'},
                { id: 9, text: '1.9 - Objects & Methods'}
            ]},
            { id: 1, title: "Up Next", content: [
                { id: 10, text: '1.10 - Tuples, Sets & Lists'},
                { id: 11, text: '1.11 - Dictionaries'},
                { id: 12, text: '1.12 - Loops'}
            ]},
            { id: 1, title: "My Python Adventures", content: [
                { id: 13, text: 'Terraria Server Project' }
        ]}
        ]
    },
    mutations: {
...
Vue.component('next-previous-buttons', {
    template: '<div class="next-previous"><button :disabled="onFirst" @click="first"><<</button><button :disabled="cantGoLower" @click="previous"><</button><button :disabled="cantGoHigher" @click="next">></button><button :disabled="onLast" @click="last">>></button></div>',
    methods: {
        first() {
            scroll(0,0)
            store.commit('first')
...
Vue.component('table-of-contents', {
    template: '<transition name="slide"><nav v-show="showHamburger"><div class="categories"><ul v-for="category in categories"><h1>{{ category.title }}</h1><li v-for="item in category.content"><button @click="navButtonClick(item.id)">{{ item.text }}</button></li></ul></div></nav></transition>',
    methods: {
        navButtonClick(id) {
